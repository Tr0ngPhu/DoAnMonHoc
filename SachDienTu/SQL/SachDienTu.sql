...
SET IDENTITY_INSERT BookState ON

/**Nhap lieu bang BookState**/
Insert into [dbo].[BookState](ID,name,description)
values
(1,'img1.jpg','sach how to be a bawse'),
(2,'img2.jpg','sach how to write a bestseller'),
(3,'img3.jpg','sach 7-day self'),
(4,'img4.jpg','sach the ring of truth'),
(5,'product1.jpg','truyen Harry Potter')
...
GO
/**Nhap lieu bang Category**/
Insert into [dbo].[Category] values ('T','Truyen');
Insert into [dbo].[Category] values	('R','Tieu thuyet');
Insert into [dbo].[Category] values ('S','Sach')
...
GO
/**Nhập liệu bảng Image**/
Insert into [dbo].[Image](ID, name, description,uploadTime)
values(1,'img1.jpg','sach how to be a bawse', '20012000'),
(2,'img2.jpg','sach how to write a bestseller', '20012000'),
(3,'img3.jpg','sach 7-day self', '20012000'),
(4,'img4.jpg','sach the ring of truth', '20012000'),
(5,'product1.jpg','truyen Harry Potter', '20012000')
/****** Object:  Table [dbo].[ImageDistribution]    Script Date: 1/25/2022 1:52:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
DROP TABLE [dbo].[ImageDistribution];
GO
...
GO
set identity_insert BookState off

set identity_insert ImageDistribution off
/**Nhap lieu bang ImageDistribution**/
Insert into [dbo].[ImageDistribution]( bookId,imageId )
VALUEs	(01,001),
		(02,002),
		(03,003),
		(04,004),
